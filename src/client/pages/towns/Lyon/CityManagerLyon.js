...
import managerLyon from '../../../assets/p1.jpg';
import './styleCityManagerLyon.css';

/*ceci est la page d'accueil du site web, les différentes parties de cette page sont découpé en composants
 */
class CityManagerLyon extends Component  {
    render(){
    return(
        <div class="py-5 teamLyon">
  <div class="container">
    <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-12 text-center">
            <div class="pt-2">
              ...
              <h6 class="subtitle mb-3">City Manager à Lyon</h6>
...
export default CityManagerLyon;
